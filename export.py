...
# TODO: Optim, check if the strips are proxies or full res before calling Revolver's bpy.ops.sequencer.proxy_editing_tofullres() / Check Velvet for optim there
