...
class RenderForTheWeb(bpy.types.Operator):
    ...
    preset = EnumProperty(
        items=[('youtube', 'youtube', 'Full HD mp4 with AAC audio, following recommendations from Youtube'),
    ...
    name_pattern = EnumProperty(
        items=[('folder', 'Folder', 'Use the folder\'s name as the exported file name'),
               ('blender', 'Blender file', 'Use the project\'s .blend file name as the exported file name'),
