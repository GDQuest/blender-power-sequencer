...
kmi = km.keymap_items.new('wm.pme_user_pie_menu_call', 'G', 'PRESS', ctrl=True, alt=True)
kmi_props_setattr(kmi.properties, 'pie_menu_name', 'Power Sequencer')
kmi_props_setattr(kmi.properties, 'invoke_mode', 'HOTKEY')
kmi_props_setattr(kmi.properties, 'keymap', 'Sequencer')
...
kmi = km.keymap_items.new('sequencer.meta_separate', 'G', 'PRESS', shift=True, ctrl=True)
...
kmi = km.keymap_items.new('sequencer.gap_insert', 'EQUAL', 'PRESS')
kmi = km.keymap_items.new('sequencer.snap', 'S', 'PRESS', shift=True)
kmi = km.keymap_items.new('power_sequencer.speed_up_sequence', 'EQUAL', 'PRESS', shift=True)
...
kmi = km.keymap_items.new('power_sequencer.sound_toggle_waveform', 'W', 'PRESS', alt=True)
...
kmi = km.keymap_items.new('power_sequencer.mouse_cut', 'RIGHTMOUSE', 'CLICK', ctrl=True)
...
kmi_props_setattr(kmi.properties, 'linked_time', True)
kmi = km.keymap_items.new('power_sequencer.mouse_trim', 'SELECTMOUSE', 'PRESS', shift=True, ctrl=True)
...
kmi = km.keymap_items.new('power_sequencer.grab_closest_handle_or_cut', 'G', 'PRESS', alt=True)
...
kmi_props_setattr(kmi.properties, 'auto', True)
kmi = km.keymap_items.new('wm.pm_edit', 'ACCENT_GRAVE', 'PRESS', shift=True, ctrl=True)
kmi = km.keymap_items.new('wm.pm_edit', 'ACCENT_GRAVE', 'PRESS', shift=True, ctrl=True)
kmi = km.keymap_items.new('wm.pm_edit', 'ACCENT_GRAVE', 'PRESS', shift=True, ctrl=True)
